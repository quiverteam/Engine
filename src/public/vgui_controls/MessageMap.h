...
#ifdef PLATFORM_64BITS
#define MESSAGE_FUNC_VPANEL_VPANEL( name, scriptname, t1, p1, t2, p2 )	_MessageFuncCommon( name, scriptname, 2, vgui::DATATYPE_UINT64, #p1, vgui::DATATYPE_UINT64, #p2 );	virtual void name( t1 p1, t2 p2 )
#else
#define MESSAGE_FUNC_VPANEL_VPANEL( name, scriptname, t1, p1, t2, p2 )	_MessageFuncCommon( name, scriptname, 2, vgui::DATATYPE_INT, #p1, vgui::DATATYPE_INT, #p2 );	virtual void name( t1 p1, t2 p2 )
#endif
