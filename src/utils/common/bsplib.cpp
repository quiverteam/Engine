...
BEGIN_BYTESWAP_DATADESC( StaticPropLump_t )
	...
	DEFINE_FIELD( m_nMinCPULevel, FIELD_SHORT ),
	DEFINE_FIELD( m_nMaxCPULevel, FIELD_SHORT ),
	DEFINE_FIELD( m_nMinGPULevel, FIELD_SHORT ),
	DEFINE_FIELD( m_nMaxGPULevel, FIELD_SHORT ),
