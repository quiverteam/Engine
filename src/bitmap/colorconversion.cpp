					  ...
					  int width, int height, int srcStride, int dstStride )
{
	...
	if ( srcImageFormat != IMAGE_FORMAT_ARGB8888 && srcImageFormat != IMAGE_FORMAT_ARGB8888_SRGB )
		return false;
						 ...
						 int width, int height, int srcStride, int dstStride )
{
	...
	if ( ( dstImageFormat == IMAGE_FORMAT_DXT1 ||
		...
		dstImageFormat == IMAGE_FORMAT_DXT5 ||
	        dstImageFormat == IMAGE_FORMAT_DXT5_SRGB || dstImageFormat == IMAGE_FORMAT_ATI1N ||
...
//		Assert( srcStride == 0 && dstStride == 0 );
		...
		return true;
			   ...
			   srcImageFormat == IMAGE_FORMAT_BGRX8888 ||
		           srcImageFormat == IMAGE_FORMAT_BGRX8888_SRGB ) &&	   													// and
