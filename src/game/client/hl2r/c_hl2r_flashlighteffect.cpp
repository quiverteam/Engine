...
#include "cbase.h"
#include "c_hl2r_flashlighteffect.h"
#include "dlight.h"
#include "iefx.h"
...
static ConVar r_flashlight_uberlight_enable( "r_flashlight_uberlight_enable", "0", FCVAR_CHEAT );
...
void CFlashlightEffect::UpdateLightNew(const Vector &vecPos, const Vector &vecForward, const Vector &vecRight, const Vector &vecUp )
{
	...
	m_UberlightState.m_bEnabled = r_flashlight_uberlight_enable.GetBool();
