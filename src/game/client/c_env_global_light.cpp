...
ConVar cl_globallight_fov( "cl_globallight_fov", "5" );

ConVar cl_globallight_filtersize( "cl_globallight_filtersize", "0.5" );
ConVar cl_globallight_slopescale( "cl_globallight_slopescale", "4" );
...
//		vPos = Vector( 0.0f, 0.0f, 500.0f );
	...
	// ok changing r_shadowmapresolution locks the screen cool
