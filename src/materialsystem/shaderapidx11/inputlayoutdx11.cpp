				      ...
				      D3D11_INPUT_ELEMENT_DESC *pDecl, ID3D11ShaderReflection* pReflection )
{
	...
	if ( bStaticLit )
	{
		...
		MakeInputElement( staticLitDesc, "STATICLIGHTING", DXGI_FORMAT_R8G8B8A8_UNORM, 1, nOffset );
	...
	else
	{
		...
		{
			D3D11_INPUT_ELEMENT_DESC staticLitDesc;
			MakeFallbackInputElement( staticLitDesc, "STATICLIGHTING", DXGI_FORMAT_R8G8B8A8_UNORM, nOffset );
			pDecl[nCount++] = staticLitDesc;
		}
	}
