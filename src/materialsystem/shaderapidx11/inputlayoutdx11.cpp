...
{
	{ "SV_POSITION",	0, VERTEX_POSITION,			sizeof( float32 ) * 3 },
...
static D3D11_INPUT_ELEMENT_DESC s_pVertexDesc[] = 
{
	...
	{ "BLENDINDICES",	0,	DXGI_FORMAT_R8G8B8A8_UNORM,	0,	0,	D3D11_INPUT_PER_VERTEX_DATA,	0 },
	{ "NORMAL",		0,	DXGI_FORMAT_R32G32B32_FLOAT,	0,	0,	D3D11_INPUT_PER_VERTEX_DATA,	0 },
	{ "COLOR",		0,	DXGI_FORMAT_R8G8B8A8_UNORM,	0,	0,	D3D11_INPUT_PER_VERTEX_DATA,	0 },
	{ "SPECULAR",		0,	DXGI_FORMAT_R8G8B8A8_UNORM,	0,	0,	D3D11_INPUT_PER_VERTEX_DATA,	0 },
...
{
	{ "SV_POSITION",        0,	DXGI_FORMAT_R32G32B32_FLOAT,		15,   0, D3D11_INPUT_PER_INSTANCE_DATA, UINT_MAX },
	{ "BLENDWEIGHT",	0,	DXGI_FORMAT_R32G32_FLOAT,		15,  12, D3D11_INPUT_PER_INSTANCE_DATA,	UINT_MAX },
	{ "BLENDINDICES",	0,	DXGI_FORMAT_R8G8B8A8_UNORM,		15,  20, D3D11_INPUT_PER_INSTANCE_DATA,	UINT_MAX },
	{ "NORMAL",		0,	DXGI_FORMAT_R32G32B32_FLOAT,		15,  24, D3D11_INPUT_PER_INSTANCE_DATA,	UINT_MAX },
	{ "COLOR",		0,	DXGI_FORMAT_R8G8B8A8_UNORM,		15,  36, D3D11_INPUT_PER_INSTANCE_DATA,	UINT_MAX },
	{ "SPECULAR",		0,	DXGI_FORMAT_R8G8B8A8_UNORM,		15,  40, D3D11_INPUT_PER_INSTANCE_DATA,	UINT_MAX },
...
// Computes the required input desc based on the vertex format
//-----------------------------------------------------------------------------
static unsigned int ComputeInputDesc( VertexFormat_t fmt, D3D11_INPUT_ELEMENT_DESC *pDecl, ID3D11ShaderReflection* pReflection )
{
...
//-----------------------------------------------------------------------------
ID3D11InputLayout *CreateInputLayout( VertexFormat_t fmt, ID3D11ShaderReflection* pReflection, const void *pByteCode, size_t nByteCodeLen )
{
