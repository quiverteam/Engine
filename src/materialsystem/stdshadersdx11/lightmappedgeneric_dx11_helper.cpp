			...
			if ( bNeedRegenStaticCmds )
			{
				...
				if ( !hasBaseTexture )
				{
					if ( hasEnvmap )
					{
						...
						BindStandardTexture( SHADER_SAMPLER0, TEXTURE_BLACK );
					}
					else
					{
						BindStandardTexture( SHADER_SAMPLER0, TEXTURE_WHITE );
					}
				}
				BindStandardTexture( SHADER_SAMPLER1, TEXTURE_LIGHTMAP );
