...
float CShaderAPIGL::GetShadowDepthBias() const { return 0; }
float CShaderAPIGL::GetShadowSlopeScaleDepthBias() const { return 0; }
...
ImageFormat CShaderAPIGL::GetNearestSupportedFormat( ImageFormat fmt ) const
{
	return fmt;
}
