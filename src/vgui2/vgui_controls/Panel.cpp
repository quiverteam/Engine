...
{
	CallParentFunction(new KeyValues("OnRequestFocus", "subFocus", subFocus, "defaultPanel", (int)defaultPanel));
}
		...
		for ( int i = 0; i < panelMap->entries.Count(); i++ )
		{
			...
			if (iMessageName == pMap->nameSymbol)
			{
				...
				case 2:
				{
					...
					{
						typedef void ( Panel:: * MessageFunc_Uint64Uint64_t )( uint64, uint64 );
						( this->*( (MessageFunc_Uint64Uint64_t )pMap->func ) )( param1->GetUint64(), param2->GetUint64() );
					}
